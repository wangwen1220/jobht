 ...
 */
define("atans/artDialog/6.0.0/dialog-plus-debug", [ "jquery-debug", "./dialog-debug", "./popup-debug", "./dialog-config-debug", "./ui-dialog-debug.css", "./drag-debug" ], function(require) {
 ...
 * For details, see: http://www.gnu.org/licenses/lgpl-2.1.html
 */
define("atans/artDialog/6.0.0/drag-debug", [ "jquery-debug" ], function(require) {
    var $ = require("jquery-debug");
    var $window = $(window);
    var $document = $(document);
